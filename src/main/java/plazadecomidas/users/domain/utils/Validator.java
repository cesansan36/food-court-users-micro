...
public class Validator {
    ...
    private static final String DOCUMENT_NUMBER_PATTERN = "\\d+";
    ...
    private static final Pattern DOCUMENT_NUMBER_REGEX = Pattern.compile(DOCUMENT_NUMBER_PATTERN);
    ...
    public static boolean isValidDocumentNumber(String documentNumber) {
        return DOCUMENT_NUMBER_REGEX.matcher(documentNumber).matches();
    }
