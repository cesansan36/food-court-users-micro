...
class UserControllerAdapterTest {
    ...
    void setUp() {
        ...
        userControllerAdapter = new UserControllerAdapter(userServicePort, ownerUserRequestMapper, employeeUserRequestMapper, userCreatedResponseMapper, logInRequestMapper, logInResponseMapper);
