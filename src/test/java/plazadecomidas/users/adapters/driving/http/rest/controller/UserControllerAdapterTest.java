...
class UserControllerAdapterTest {
    ...
    void setUp() {
        ...
        userControllerAdapter = new UserControllerAdapter(userServicePort, ownerUserRequestMapper, userCreatedResponseMapper, logInRequestMapper, logInResponseMapper);
